$(document).ready(function () {
    ...
    $("#staticIp").on("keyup change", function () {
        process_ip($(this).attr("id"),"btnAddWan");
    });

    $("#pppoeMaxFailedPing, #pppoePingInterval").on("keyup change", function () {
        process_ping($(this).attr("id"), "btnAddWan");
    });

    $("#netmask").on("keyup change", function () {
        process_subnet($(this).attr("id"), "btnAddWan");
    });
    ...
    function selectConnectionType() {
        if ($("#connectionTypeOptions").val() == 'dhcp') {
            ...
            process_user("pppoeUser", "btnAddWan");
            ...
            $("#pppoeServiceName").on("keyup change",function(){
                if($("#pppoeServiceName").val() != ""){
                    validatePppoeServiceName("pppoeServiceName", "btnAddWan");
            ...
            $("#connectionTypePPPOEDiv").hide();
            process_static_ip("staticIp", "btnAddWan");
            process_static_ip("staticIp", "btnSave");

            process_subnet("netmask", "btnAddWan");
    ...
    function checkPrimaryDns(){
        if($("#primaryDNS").val() != "") {
            process_dns($("#primaryDNS").attr("id"), "btnAddWan");
    ...
    function validateWanName() {
        $("#wanName").on("keyup change",function(){
            if($("#wanName").val() != '') {
                process_wan_name("wanName", "btnAddWan");
    ...
    function validateSecondaryDns() {
        $("#secondaryDns").on("keyup change",function(){
            if($("#secondaryDns").val() != '') {
                process_dns("primaryDNS","btnAddWan");
                process_dns("primaryDNS","btnSave");

                if(process_dns($(this).attr("id"), "btnAddWan") || process_dns($(this).attr("id"), "btnSave"))
                    process_dns("primaryDNS","btnAddWan");
                    process_dns("primaryDNS","btnSave");
            }
            else{
    ...
    function validateCustomMacAddr() {
        $("#customMacAddr").on("keyup change",function(){
            if($("#customMacAddr").val() != ""){
                process_mac($(this).attr("id"), "btnAddWan");
    ...
    function validateCustomMtu() {
        $("#customMtu").on("keyup change", function(){
            if($("#customMtu").val() != ""){
                process_mtu($(this).attr("id"), "btnAddWan");
    ...
    function validateTrackingIP(id) {
        ...
        $("#trackingIP_"+id).on("keyup change", function () {
            process_dns($(this).attr("id"), "btnAddWan");
    ...
    function save() {
        $("#btnAddWan, #btnSave").click(function () {
